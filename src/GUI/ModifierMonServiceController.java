 ...
 * @author chayma
 */
public class ModifierMonServiceController implements Initializable, MapComponentInitializedListener {
    ...
    @FXML
    private TextField ouv;
    @FXML
    private TextField ferm;
    @FXML
    private TextField tarif;
    @FXML
    private TextArea dip;
    @FXML
...
id.setVisible(false);
    id.setText(String.valueOf(ConsulterMonServiceController.ID));
        ...
        ouv.setText(ConsulterMonServiceController.OUVERT);
        ferm.setText(ConsulterMonServiceController.FERME);
